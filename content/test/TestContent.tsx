...
/* Externals */
import { Close, ExpandMore, Help, HelpOutlineRounded, HelpRounded, NavigateBefore, NavigateNext, RamenDining } from "@mui/icons-material";
import { Box, Button, ButtonBase, Card, CardActions, CardContent, CardMedia, Chip, Divider, Grow, IconButton, List, ListItemAvatar, ListItemButton, ListItemText, ListSubheader, Stack } from "@mui/material";
