...
import { AppBar, Button, CardContent, Divider, Stack, Toolbar } from "@mui/material";
...
import CityChemistryAccordion from "../chemistry/component/CityChemistryAccordion";

/* Loadable Components */
// const  = loadable(() => import( /* webpackChunkName: "CityChemistryAccordion" */ './component/CityChemistryAccordion'));

interface CityDetailContentProps {
    cityType: keyof typeof TEST.city.subTests;
}

function CityDetailContent({ cityType }: CityDetailContentProps) {
